            ...
            <div className="space-y-14">
              <section className="will-reveal">
                ...
                <p className="text-lead text-ivory/72">
                  Most people who sell gold do it once or twice in their lives,
                  often at a difficult moment, and almost always without knowing
                  what their item actually weighs or what it is actually made
                  of. That asymmetry is the whole problem with the trade.
                </p>
                <p className="mt-5 text-lead text-ivory/72">
                  {brand.shortName} is built on closing it: the weight is shown,
              ...
              <section className="will-reveal">
                ...
                <p className="text-lead text-ivory/72">
                  Every figure begins with a number that can be independently
                  checked. Weight is not negotiable and not a matter of opinion
              ...
              <section className="will-reveal">
                ...
                <p className="text-lead text-ivory/72">
                  Gold arrives with circumstances attached — an estate, a
                  separation, a business that needs cash this month. None of
                  that is anyone else&apos;s business, and the service is
                  arranged so that it does not have to be discussed in front of
                  a queue.
                </p>
              </section>
