...
export function ScalePoster({ className = '', dimmed = false }: ScalePosterProps) {
  return (
    <svg
      className={className}
    ...
    >
      ...
      <path d="M 60 -40 L 420 -40 L 760 900 L 250 900 Z" fill="url(#pw-shaft)" />
      ...
      <g>
        ...
        <path d="M 404 726 L 796 726 L 762 700 L 438 700 Z" fill="url(#pw-iron)" />
        {/* Inlaid ornamental band. */}
        <rect x="392" y="729" width="416" height="6" fill="url(#pw-gold)" opacity="0.9" />
        <rect x="440" y="702" width="320" height="3" fill="url(#pw-gold)" opacity="0.55" />
      </g>
      ...
      <g>
        ...
        />
        {/* Turned gold collars. */}
        <ellipse cx="600" cy="668" rx="42" ry="7" fill="url(#pw-gold)" opacity="0.92" />
        <ellipse cx="600" cy="404" rx="26" ry="5" fill="url(#pw-gold)" opacity="0.92" />
        <ellipse cx="600" cy="372" rx="21" ry="4.5" fill="url(#pw-gold)" opacity="0.7" />
      </g>
      ...
      <g opacity="0.85">
        ...
        <path d="M 596 292 L 604 292 L 601.4 404 L 598.6 404 Z" fill="url(#pw-gold-v)" />
      </g>
      ...
      <g>
        ...
        {/* Finial. */}
        <path d="M 592 262 L 608 262 L 604 244 L 601 232 L 598 244 Z" fill="url(#pw-gold-v)" />
        {/* Suspension eyes. */}
        <circle cx="238" cy="284" r="9" fill="none" stroke="url(#pw-gold)" strokeWidth="4" />
        <circle cx="962" cy="284" r="9" fill="none" stroke="url(#pw-gold)" strokeWidth="4" />
      </g>

      {/* ---- Left hanger: bullion ---- */}
      <g>
        <line x1="238" y1="292" x2="168" y2="512" stroke="#3a352d" strokeWidth="2.6" />
        <line x1="238" y1="292" x2="238" y2="512" stroke="#4a443a" strokeWidth="2.6" />
        <line x1="238" y1="292" x2="308" y2="512" stroke="#3a352d" strokeWidth="2.6" />

        <path
          d="M 150 516 C 150 556, 200 578, 238 578 C 276 578, 326 556, 326 516 Z"
          fill="url(#pw-iron)"
        />
        <ellipse cx="238" cy="516" rx="88" ry="17" fill="url(#pw-gold)" opacity="0.95" />
        <ellipse cx="238" cy="516" rx="78" ry="12" fill="#14110d" />

        {/* Cast bars. */}
        <g>
          <path d="M 176 512 L 232 512 L 228 490 L 182 490 Z" fill="url(#pw-gold)" />
          <path d="M 240 512 L 296 512 L 292 490 L 246 490 Z" fill="url(#pw-gold)" />
          <path d="M 208 488 L 266 488 L 262 466 L 214 466 Z" fill="url(#pw-gold)" />
          <rect x="222" y="472" width="30" height="2" fill="#7a5414" opacity="0.7" />
          <rect x="226" y="477" width="22" height="2" fill="#7a5414" opacity="0.55" />
        </g>
      </g>

      {/* ---- Right hanger: the sealed valuation block (deliberately not cash) ---- */}
      <g>
        <line x1="962" y1="292" x2="892" y2="512" stroke="#3a352d" strokeWidth="2.6" />
        <line x1="962" y1="292" x2="962" y2="512" stroke="#4a443a" strokeWidth="2.6" />
        <line x1="962" y1="292" x2="1032" y2="512" stroke="#3a352d" strokeWidth="2.6" />

        <path
          d="M 874 516 C 874 556, 924 578, 962 578 C 1000 578, 1050 556, 1050 516 Z"
          fill="url(#pw-iron)"
        />
        <ellipse cx="962" cy="516" rx="88" ry="17" fill="url(#pw-gold)" opacity="0.95" />
        <ellipse cx="962" cy="516" rx="78" ry="12" fill="#14110d" />

        <g>
          <path d="M 924 512 L 1000 512 L 1000 442 L 924 442 Z" fill="#0d0c0a" />
          <path d="M 924 442 L 1000 442 L 998 434 L 926 434 Z" fill="#191713" />
          <rect x="920" y="486" width="84" height="9" fill="url(#pw-gold)" opacity="0.9" />
          <rect x="920" y="452" width="84" height="6" fill="url(#pw-gold)" opacity="0.72" />
          <circle cx="962" cy="428" r="13" fill="url(#pw-gold)" />
          <circle cx="962" cy="428" r="8" fill="none" stroke="#5c3f10" strokeWidth="1.6" />
        </g>
      </g>
